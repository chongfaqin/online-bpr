...
class Data_preprocessor():
    ...
    def train_test_split(self,time_range=86400):
        ...
        train = self.data[np.in1d(self.data['userId'] , session_tmax[session_tmax<=tmax -time_range].index)]
        test = self.data[np.in1d(self.data['userId'] , session_tmax[session_tmax>tmax -time_range].index)]
